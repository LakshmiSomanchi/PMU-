...
from sqlalchemy import Column, Integer, String, Text, Float, ForeignKey, create_engine  # Added Float import
...
st.markdown("""
    <style>
        ...
        .stApp {
            background-color: rgba(255, 255, 255, 0.99); /* Increased transparency for better visibility */
        }
